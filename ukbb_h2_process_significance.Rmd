...
Having established a [list of phenotypes where we have reasonable confidence](confidence.html) in the LDSR results, we can now address the question of which phenotypes are significantly heritable.
