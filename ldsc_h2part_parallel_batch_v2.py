...
phen_summary = 'gs://ukbb-gwas-imputed-v3-results/phenotypes.{}.tsv.gz' # in cloud
ss_bucket = 'gs://ukb31063-mega-gwas/hail-0.1/ldsc-sumstats-tsvs' # bucket with sumstats.gz files
out_bucket = 'gs://ukb31063-ldsc-results/h2part/batches' # ouput google bucket location
...
parser.add_argument('--phsource', type=str, required=True, help="phenotype set (e.g. phesant, icd10)")
...
h2_fname = 'ukbb31063.'+str(sex_group)+'.h2part_results.'+str(phsource)+'.batch_'+str(args.paridx)+'.tsv.gz'
